...
import {
  readDerivedDocumentContent,
  readOriginalDocument,
  type DocumentReadDependencies,
} from './upload-document-reader';

export {
  resolveOriginalDocumentContentType,
} from './upload-document-reader';
export type { DocumentReadDependencies } from './upload-document-reader';
...
export class UploadService {
  ...
  async getFileContent(
    ...
    return readDerivedDocumentContent(userId, id, requestId, dependencyOverrides);
  }
  ...
  async getFileOriginal(
    ...
    return readOriginalDocument(userId, id, requestId, dependencyOverrides);
  }
